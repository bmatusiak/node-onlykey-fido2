module.exports = function(imports) {
    return new Promise(async function(resolve) {
        ...
        const crypto = imports.window.crypto;
        const atob = imports.window.atob;
        const btoa = imports.window.btoa;
        ...
        async function doConnect() {
            ...
            function pushToMessage(msg_section_name, message_section) {
                var msg = {};
                msg[msg_section_name] = toHexString(message_section);
                console.log(msg)
            ...
            var challenge = Uint8Array.from(crypto.randomBytes ? crypto.randomBytes(32) : crypto.getRandomValues(new Uint8Array(32)) );
